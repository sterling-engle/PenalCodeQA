...
models = np.array([[
    ...
    [ 48, "Kernel", "cutlass_80_tensorop_s1688gemm_128x64_16x6_tn_align4",
     "xlarge", 32, 679, (3, 25),
     "void cutlass::Kernel<cutlass_80_tensorop_s1688gemm_128x64_16x6_tn_align4>"
     "(cutlass_80_tensorop_s1688gemm_128x64_16x6_tn_align4::Params)",
     320, 128, 40960, 8, 148, 0, 73.73, 1.02, 102.40,
     105.04, 0, 91.37, 14.63,
     47.10, 45.92, 36.39, 45.92, 23.88, 934.94, 1115108, 1108240.07, 1.19, 6.87,
     6484, 6400
    ],
    ...
    [ 24, "Kernel", "cutlass_80_tensorop_s1688gemm_128x64_16x6_nn_align1",
     "medium", 20, 664, (28),
     "void cutlass::Kernel<cutlass_80_tensorop_s1688gemm_128x64_16x6_nn_align1>"
     "(cutlass_80_tensorop_s1688gemm_128x64_16x6_nn_align1::Params)",
...
def calcModelKernelDuration(modelId, kernelId):
    ...
    if kernelId == k_unrolled_elementwise_kernel_copy_device_to_device_medium \
       or (kernelId == k_unrolled_elementwise_kernel_copy_device_to_device_small):
    ...
    printlog(f"Kernel #{kernelId} {kernel[p_function]}-{kernel[p_sub_function]}-"
...
def main():
    ...
    printlog(f"Performance modeling {gpu_names[0:]} for one question inference using:")
    printlog("")
